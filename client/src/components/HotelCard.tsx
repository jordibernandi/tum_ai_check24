      ...
      <Card className="overflow-hidden h-full transition-shadow duration-300 hover:shadow-lg bg-white border-neutral-200">
        ...
        <CardContent className="p-5 text-foreground">
          <div className="flex justify-between items-start mb-2">
            <h3 className="font-semibold text-lg line-clamp-1">{hotel.hotel_name}</h3>
          ...
          <div className="flex items-center text-neutral-500 text-sm mb-3">
            ...
            <span>{hotel.locationname}, Copenhagen</span>
            <span className="mx-2">•</span>
            <i className="fas fa-star text-secondary text-xs mr-1"></i>
            <span>{hotel.starcategory}-star {hotel.starcategory >= 4 ? 'hotel' : 'property'}</span>
          </div>
          ...
          <div className="flex items-end justify-between">
            ...
            <Dialog>
              ...
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  <DialogTitle className="text-lg font-semibold">{hotel.hotel_name}</DialogTitle>
                </DialogHeader>
                {hotel.explanability}
              </DialogContent>
            </Dialog>
